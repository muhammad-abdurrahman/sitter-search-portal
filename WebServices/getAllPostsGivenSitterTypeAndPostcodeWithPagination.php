...
$lewishamServiceUrl = 'http://stuiis.cms.gre.ac.uk/am238/soa/lewisham/LewishamService.asmx/getAllLewishamPostsGivenSitterTypeAndPostcodeWithPagination'
        . '?sitterType=' . $sitterType . '&postcode=' . $postcode . '&fromRecordNo=' . $fromRecordNo . '&toRecordNo=' . $toRecordNo;
$greenwichServiceUrl = 'http://stuweb.cms.gre.ac.uk/~am238/soa/greenwich/WebServices/getAllGreenwichPostsGivenSitterTypeAndPostcodeWithPagination.php'
        . '?sitterType=' . $sitterType . '&postcode=' . $postcode . '&fromRecordNo=' . $fromRecordNo . '&toRecordNo=' . $toRecordNo;
